...
val passportClient by lazy {
    Ktorfit.Builder().httpClient(ktorClient).baseUrl(PASSPORT_BASE).build()
}

val biliClient by lazy {
    Ktorfit.Builder().httpClient(ktorClient).baseUrl(API_BASE).build()
}

val bangumiClient by lazy {
    Ktorfit.Builder().httpClient(ktorClient).baseUrl(BANGUMI_BASE).build()
}
